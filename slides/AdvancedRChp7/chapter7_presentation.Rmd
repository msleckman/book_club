...
- Use the [HackMD](https://hackmd.io/@Alejandra/r13GR7FjL) to present yourself, ask questions and see your breakout room 
--
...
## **Question 1:** What is the difference between `lobstr::cst()` and `traceback()`? 
...
## **Question 2:**	Let’s say you first load package `tseries` and then `chron`, both containing a function named `is.weekend`. From which package does R use the function and why? What does this have to do with environments in R? 
...
## **Question 3:**	Which of the following characteristics is not a difference between an environment and a named list? 
...
## **Question 4:**	Which of the following code will show you the full ancestry of environment e2b? 
&nbsp;
&nbsp;
--
...
---
## **Question 5:**	What is the difference between assignment (`<-`) and super assignment (`<<-`)? And when is this useful?
...
## **Question 6:**	Which of the following gives an error?
...
---
## **Question 7:**	Which of the following code removes an element from an environment?
